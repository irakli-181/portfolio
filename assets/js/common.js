...
$(function() {
	...
	**/
	...
	document.getElementById("myForm").addEventListener("submit", function(event) {
		...
		// Send the data to the webhook using AJAX
		var xhr = new XMLHttpRequest();
		xhr.open("POST", "https://hook.eu1.make.com/97wvpgvtqp9qfpxqqvicai649v1r84j1", true);
		xhr.onreadystatechange = function() {
		  if (xhr.readyState === 4 && xhr.status === 200) {
			// Display a "Thank you" message
			document.getElementById("response").innerHTML = "Thank you for your submission!";
		  }
		};
		xhr.send(formData);
	  });
